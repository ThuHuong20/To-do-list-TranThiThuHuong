...
export default function Navbar({ handleAddJob, isEdit, handleUpdate }) {
    ...
    React.useEffect(() => {
        if (isEdit) {
            setsearchJobs(isEdit.searchJobs)
            setIsSave(true)
        } else {
            setsearchJobs("")
            setIsSave(false)
            ...
            <AppBar position="static">
                <Toolbar>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        ...
                        <IconButton size="large" aria-label="show 4 new mails" color="inherit">
                            {!isSave ? (<span className="material-symbols-outlined"
                                onClick={() => {
                                    if (searchJobs !== '') {
                                        handleAddJob({
                                            type: 'addJob',
